				...
				<el-timeline>
					...
					<el-timeline-item>
						<el-card class="box-card">
							...
							<el-form label-width="60px">
								...
								<el-button type="primary" plain style="width: 100%" size="small" @click="step1()"> 生成座位模板 </el-button>
							</el-form>
						</el-card>
					</el-timeline-item>
					<!-- 第二步 -->
					...
					<el-timeline-item>
						<el-card class="box-card">
							...
							<el-button type="success" style="width: 100%" size="small" @click="step4()"> 选好了 </el-button>
						</el-card>
					</el-timeline-item>
				</el-timeline>
			</el-aside>
